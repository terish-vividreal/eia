<div id="data-create-modal" class="modal">
    {!! Form::open(['class'=>'ajax-submit', 'id'=> Str::camel($page->title).'Form']) !!}
      ...
      <a class="btn-floating mb-1 waves-effect waves-light right modal-close"><i class="material-icons">clear</i></a>
          ...
          {{ csrf_field() }}
          {!! Form::hidden('departmentId', '' , ['id' => 'departmentId'] ); !!}
          ...
          <div class="card-body" id="">
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <label for="name" class="label-placeholder active"> Department <span class="red-text">*</span></label>
                </div>
                <div class="input-field col s12">
                  {!! Form::textarea('description', '', ['id' => 'description', 'class' => 'materialize-textarea']) !!}
