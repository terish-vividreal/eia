          ...
          <div id="borderless-table" class="card card-tabs">
              <div class="card-content data-table-container">
                  ...
                  <div id="view-borderless-table">
                    <div class="row">
                      <div class="col s12">
                        <table id="data-table-designation" class="display data-tables" data-url="{{ $page->link.'/lists' }}" data-form="page" data-length="10">
                          <thead>
                              <tr>
...
@include('admin.designations.manage')
@endsection
...
<script src="{{asset('admin/js/custom/designations/designations.js')}}"></script>
<script>
