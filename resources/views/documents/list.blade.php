                          ...
                          <form id="page-form" name="page-form">
                            ...
                            <div class="row">
                              <div class="input-field col m3 s12">
                                  {!! Form::text('searchTitle', '', array('id' => 'searchTitle', 'placeholder' => 'Project Title')) !!}
                              </div>
                              <div class="input-field col m3 s12">
                        ...
                        <table id="data-table-projects" class="display data-tables" data-url="{{ $page->link }}" data-form="page" data-length="10">
                          <thead>
                            <tr>
                              ...
                              <th width="500px" data-orderable="true" data-column="document_number"> Document Number </th>
                              <!-- <th width="200px" data-orderable="false" data-column="date_of_creation"> Date Of Creation </th>
                              <th width="" data-orderable="true" data-column="category_id"> Category </th>
                              <th width="" data-orderable="false" data-column="company_id"> Company </th>
                              <th width="" data-orderable="false" data-column="project_type"> Project Type </th>                              
